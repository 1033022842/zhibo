...
-- Records of ba_admin
-- ----------------------------
INSERT INTO `ba_admin` VALUES (1, 'admin', 'Admin', '', 'admin@buildadmin.com', '18888888888', 0, 1785572360, '127.0.0.1', '$2y$10$b/w7wjNIymPfjY62LTInBuelicvFAjdMLXNUJhrd7ZvI/ckt3FQDm', '', '', 'enable', 1785572360, 1778942775);
...
CREATE TABLE `ba_admin_log`  (
  ...
  `create_time` bigint(16) UNSIGNED NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 307 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '管理员日志表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ba_attachment`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '附件表' ROW_FORMAT = Dynamic;
...
-- Records of ba_token
-- ----------------------------
INSERT INTO `ba_token` VALUES ('1c7494f60279ef03f1e4cae6bd1145b8e82be9aa', 'admin', 1, 1785330939, 1785590139);
...
INSERT INTO `ba_token` VALUES ('d70e9df11c78a7a0c72d5f0ea2d5d32c66c42463', 'admin', 1, 1785399419, 1785658619);
...
CREATE TABLE `lp_gift_order`  (
  ...
  INDEX `idx_room_created`(`room_id`, `created_at`) USING BTREE,
  INDEX `idx_user_created`(`user_id`, `created_at`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 246 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '礼物订单' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 5468 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '房间分钟聚合数据' ROW_FORMAT = Dynamic;
...
INSERT INTO `lp_room_state_snapshot` VALUES (6, 'public_live', 'public', NULL, NULL, 101, '2026-08-01 16:19:20');
...
-- ----------------------------
INSERT INTO `lp_user_profile` VALUES (1, 0, '', '', '127.0.0.1', '2026-07-31 22:54:19');
INSERT INTO `lp_user_profile` VALUES (2, 0, '', '', '127.0.0.1', '2026-07-31 20:26:48');
INSERT INTO `lp_user_profile` VALUES (3, 0, '', '', '127.0.0.1', '2026-08-01 14:54:55');

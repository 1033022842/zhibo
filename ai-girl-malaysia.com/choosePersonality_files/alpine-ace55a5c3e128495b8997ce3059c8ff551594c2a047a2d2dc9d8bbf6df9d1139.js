(() => {
  ...
  (() => {
    ...
    function nt(e) {
      ...
      for (let o of t)
        r.includes(o) || !o.isConnected || (delete o._x_ignoreSelf, delete o._x_ignore, Ut.forEach((s) => s(o)), o._x_ignore = true, o._x_ignoreSelf = true);
      t.forEach((o) => {

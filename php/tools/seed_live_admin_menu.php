    ...
    [
        ...
        'children' => [
            ...
            [
                ...
                'path' => 'live/gift',
                'icon' => 'fa fa-gift',
                'component' => '/src/views/backend/live/gift/index.vue',
                'menu_type' => 'tab',
                'url' => '',
                'extend' => 'none',
                'remark' => '直播礼物配置',
                'weigh' => 116,
                'children' => [
                    ['type' => 'button', 'title' => '查看', 'name' => 'live/gift/index', 'path' => '', 'icon' => '', 'component' => '', 'menu_type' => 'tab', 'url' => '', 'extend' => 'none', 'remark' => '', 'weigh' => 10],
                    ['type' => 'button', 'title' => '新增', 'name' => 'live/gift/add', 'path' => '', 'icon' => '', 'component' => '', 'menu_type' => 'tab', 'url' => '', 'extend' => 'none', 'remark' => '', 'weigh' => 9],
                    ['type' => 'button', 'title' => '编辑', 'name' => 'live/gift/edit', 'path' => '', 'icon' => '', 'component' => '', 'menu_type' => 'tab', 'url' => '', 'extend' => 'none', 'remark' => '', 'weigh' => 8],
                    ['type' => 'button', 'title' => '删除', 'name' => 'live/gift/del', 'path' => '', 'icon' => '', 'component' => '', 'menu_type' => 'tab', 'url' => '', 'extend' => 'none', 'remark' => '', 'weigh' => 7],
                    ['type' => 'button', 'title' => '选择', 'name' => 'live/gift/select', 'path' => '', 'icon' => '', 'component' => '', 'menu_type' => 'tab', 'url' => '', 'extend' => 'none', 'remark' => '', 'weigh' => 6],
                ],
            ],
        ],
    ],
